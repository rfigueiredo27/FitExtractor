...
/**
 * Servlet implementation class InsereStravaController
 */
@WebServlet("/InsereStrava")
public class InsereStravaController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public InsereStravaController() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher rd = request.getRequestDispatcher("ListaURL?app=284597785309");
